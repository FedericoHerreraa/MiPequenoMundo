    ...
    return  (
        <>
            <div className="flex flex-col items-center border-t border-red-500 mx-10 mt-40">
                <h1 className="text-6xl my-10 text-blue-900 font-mono">¿Dónde estamos?</h1>
                <div  className="m-20">
                    <div className="flex items-center gap-3">
                        <img src={mapSolid} alt="" />
                        <p className="text-lg text-blue-900 py-3 font-medium"><strong>Jardín maternal:</strong> 25 de Mayo 525 Vicente Lopez</p>
                    </div>
            ...
            <div className="flex flex-col items-center mx-10 mt-20">
                <div className="m-20">
                    <div className="flex items-center gap-3">
                        <img src={mapSolid} alt="" />
                        <p className="text-lg text-red-800 py-3 font-medium"><strong>Jardín infante:</strong> Tomas Edison 492 Vicente Lopez</p>
                    </div>
