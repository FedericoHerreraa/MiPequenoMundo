...
const NuestraHistoria: React.FC = () => {
    return (
        <div className="">
            ...
            <div className="h-32 shadow-2xl flex justify-center items-center">
                <h1 className="md:text-5xl text-4xl text-blue-900 font-mono">Nuestra historia</h1>
            </div>
            <div className="flex justify-center">
                <div className="md:w-2/3 md:mx-auto mx-3 mt-10">
                    <p className="line leading-6 text-lg"><strong>E</strong>n un tranquilo rincón de la ciudad, se erige un encantador edificio que alberga un espacio mágico donde la risa de los  más pequeños y la ternura se entrelazan en un ballet de inocencia. Este es el Jardín de Infantes y Maternal <span className="text-red-700">"Mi pequeño mundo"</span>, un lugar donde los sueños de los niños comienzan a tomar forma desde temprana edad.
            ...
            <div className="h-60 shadow-2xl my-10">
            </div>
            <div className="flex justify-center">
                <div className="md:w-2/3 md:mx-auto mx-3 mt-10 mb-20">
                    <p className="line leading-6 text-lg">
